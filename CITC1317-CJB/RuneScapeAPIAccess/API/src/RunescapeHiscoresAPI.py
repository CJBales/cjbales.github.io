...
from RuneScapeAPIAccess.API.util.commonImports import User_Agent_Strings, URL_Templates
from RuneScapeAPIAccess.API.src._MainAPI import _API as API
...
if __name__ == "__main__":
    ...
    hiscores_API = RunescapeHiScoresAPI()


    for username in username_list:
        hiscores_API.get_player_hiscore(username)
        print("\n\n")
        sleep(5)