$(document).ready(() => {
    ...
    $(document).load("https://collectionapi.metmuseum.org/public/collection/v1/search?q=%22%22&hasImage=true&departmentId=12", (response) => {
        ...
        for(let i = 0; i < data.objectIDs.length; i++) {
            ...
            $(document).load(`https://collectionapi.metmuseum.org/public/collection/v1/objects/${data.objectIDs[i]}`, (objectResponse) => {
                ...
                $(`#row-${i}`).append(imageHolder, title, date);
